...
public class DefaultSender implements Sender {
    ...
    @Override
    public ScheduledFuture send(MessengerUser recipient, List<GenericElement> elements, Integer delayMillis) {
    ...
    @Override
    public ScheduledFuture send(MessengerUser recipient, List<GenericElement> elements, List<QuickReply> quickReplies, Integer delayMillis) {
